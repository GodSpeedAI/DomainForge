use domainforge_core::calm::export::export;
use domainforge_core::kg::KnowledgeGraph;
use domainforge_core::parser::ast::{AstNode, TargetFormat};
...
fn test_graph_integration() {
    ...
    let graph = domainforge_core::parser::ast::ast_to_graph(ast).expect("Failed to build graph");
