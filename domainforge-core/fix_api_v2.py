...
class ImportInserter(RustTransformer):
    ...
    def add_import(self, source_code: str, import_name: str, module: str = 'domainforge_core::units') -> str:
    ...
    def _create_new_import(self, import_name: str, module: str = 'domainforge_core::units'):
