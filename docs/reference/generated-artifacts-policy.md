...
- **Rust source**: `sea-core/src/`, `sea-core/grammar/`
- **Grammar**: `sea-core/grammar/sea.pest`
- **Schemas and manifests**: `Cargo.toml`, `sea-core/Cargo.toml`, `pyproject.toml`, `package.json`
- **Lockfiles**: `Cargo.lock`, `bun.lock`
- **Documentation**: `docs/`, `README*.md`, `CONTRIBUTING.md`
- **Examples**: `examples/`, `sea-core/examples/`
- **Tests**: `sea-core/tests/`, `tests/`, `typescript-tests/`
...
- `sea-core/pkg/` — WASM package output (generated by `wasm-pack`)
