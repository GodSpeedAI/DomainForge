...
- `typescript`: enables napi-rs bindings (`domainforge`).
...
## TypeScript package (`domainforge`)
...
- **TypeScript**: `node_modules/domainforge` native addon; resolves platform-specific `.node` files.
