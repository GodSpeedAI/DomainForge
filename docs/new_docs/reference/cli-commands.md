...
- `--version` prints `sea-core <version>` (currently `0.1.0`).
...
Policy JSON schema matches `sea-core::policy::Policy`. See `docs/new_docs/reference/primitives-api.md` for the policy type.
...
- `docs/new_docs/how-tos/install-cli.md` for installation and verification.
- `docs/new_docs/how-tos/parse-sea-files.md` for parsing guidance.
- `docs/new_docs/how-tos/export-to-calm.md` and `import-from-calm.md` for data exchange.
- `docs/new_docs/reference/error-codes.md` for interpreting validation failures.
...
- The CLI respects semantic versioning with breaking changes gated to major bumps; see `docs/new_docs/explanations/versioning-strategy.md`.
