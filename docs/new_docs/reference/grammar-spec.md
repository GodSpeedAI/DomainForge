...
role_mod = { "namespace" ~ quoted | "attributes" ~ attribute_block }
```
...
Refer to `docs/new_docs/reference/error-codes.md` for the exhaustive error catalog.
...
- `docs/new_docs/reference/primitives-api.md` for data structures produced by parsing.
- `docs/new_docs/how-tos/parse-sea-files.md` for CLI and language-specific parsing examples.
- `docs/new_docs/reference/error-codes.md` for validation failures.
- `docs/new_docs/explanations/semantic-modeling-concepts.md` for modeling guidance.
