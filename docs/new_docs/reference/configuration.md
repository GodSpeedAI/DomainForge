...
- `--format <human|json>`: output style for `parse`, `validate`, `project`, `eval`.
...
- `docs/new_docs/reference/cli-commands.md` for command usage.
- `docs/new_docs/how-tos/install-cli.md` for installation prerequisites per platform.
- `docs/new_docs/explanations/versioning-strategy.md` for how configuration changes are versioned.
