...
fn test_check_comparison_valid() {
    let q1 = ExprType::Quantity { dimension: Dimension::Mass };
    let q2 = ExprType::Quantity { dimension: Dimension::Mass };
...
fn test_check_comparison_unit_mismatch() {
    let q1 = ExprType::Quantity { dimension: Dimension::Mass };
    let q2 = ExprType::Quantity { dimension: Dimension::Length };
...
fn test_check_comparison_mixed_types() {
    let q = ExprType::Quantity { dimension: Dimension::Mass };
