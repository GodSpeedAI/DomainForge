...
impl ProtoFile {
    ...
    pub fn to_proto_string(&self) -> String {
        ...
        // Header comments
        out.push_str(&format!("// Generated by SEA Projection Framework\n"));
        out.push_str(&format!(
            "// Projection: {}\n",
...
mod tests {
    ...
    fn test_streaming_mode_from_str() {
        assert_eq!(
            StreamingMode::from_str("streaming"),
            StreamingMode::ServerStreaming
        );
        assert_eq!(
            StreamingMode::from_str("server_streaming"),
            StreamingMode::ServerStreaming
        );
        assert_eq!(
            StreamingMode::from_str("client_streaming"),
            StreamingMode::ClientStreaming
        );
        assert_eq!(
            StreamingMode::from_str("bidirectional"),
            StreamingMode::Bidirectional
        );
        assert_eq!(
            StreamingMode::from_str("bidi"),
            StreamingMode::Bidirectional
        );
        assert_eq!(
            StreamingMode::from_str("duplex"),
            StreamingMode::Bidirectional
        );
